...
def notifications():
    ...
    st.session_state.notifications["weather"] = st.checkbox("Weather Alerts", value=st.session_state.notifications["weather"])
    st.session_state.notifications["crop"] = st.checkbox("Crop Alerts", value=st.session_state.notifications["crop"])
